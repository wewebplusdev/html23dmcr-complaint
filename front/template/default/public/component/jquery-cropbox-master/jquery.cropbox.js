(function () {
    ...
    function factory($) {
        function Crop($image, options, on_load) {
            ...
            this.img_origi_width = null;
            this.img_origi_height = null;
        ...
        Crop.prototype = {
            init: function () {
                ...
                var defaultControls = $('<div/>', {'class': 'cropControls'})
                        ...
                        .append($('<button/>', {'class': 'cropRotage', 'type': 'button'}).on('click', $.proxy(this.rotage, this)))
...
//                }
            ...
            drag: function (data, skipupdate) {
                //console.log(this.img_width + ":" + this.options.width);
            ...
            rotage: function (data) {
                   console.log(this.fit);
                if (this.img_rotage == 360) {
                    this.img_rotage = 0;
                } else {
                    this.img_rotage = this.img_rotage + 90;
                }
                //  console.log(this.img_rotage);
//                if (this.img_rotage > 0 && this.img_rotage < 180 || this.img_rotage > 180 && this.img_rotage < 270) {
//
//                    var oldWidth = this.img_width;
//                    var oldHeight = this.img_height;
//
//                    this.img_width = oldHeight;
//                    this.img_height = oldHeight;
////                    var oldTop = this.img_top;
////                    var oldLeft = this.img_left;
////
////                    this.img_top = oldLeft;
////                    this.img_left = oldTop;
//                } else if (oldWidth && oldHeight) {
//                    this.img_width = oldWidth;
//                    this.img_height = oldHeight;
//                }

                this.$image.css({
//                    width: this.img_width, left: this.img_left, top: this.img_top,
//                    left: this.img_left,
//                    top: this.img_top,
                    '-webkit-transform': 'rotate(' + this.img_rotage + 'deg)',
                    '-moz-transform': 'rotate(' + this.img_rotage + 'deg)',
                    'transform': 'rotate(' + this.img_rotage + 'deg)'});
                this.update();
            },
            update: function () {
                if (this.img_rotage == 360) {
